...
.minutes-header small{font-size:11px;color:#8390a1}
...
.topic-num{width:20px;height:20px;border-radius:50%;background:#087c66;color:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:bold;flex-shrink:0}
.agenda-discussion{font-size:12px;color:#69778a;line-height:1.5;margin:4px 0}
.action-items{margin-top:6px}
.action-item{display:flex;align-items:center;gap:6px;font-size:11px;color:#52606d;padding:3px 0}
.action-item small{color:#8390a1}
.minutes-section ul{margin:4px 0;padding-left:20px;font-size:12px;color:#52606d}
...
.task-cards p,.task-cards small{font-size:11px;color:#69778a;line-height:1.5}
.task-cards small{display:block}
.task-assign{display:flex;align-items:center;gap:6px;margin-top:6px}
.task-assign span{font-size:10px;color:#8390a1}
